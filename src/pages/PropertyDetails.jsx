        ...
        <section>
            <div className="container mx-auto min-h-[800px] mb-14">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between ">
                    ...
                    <div className="text-3x font-semibold text-violet-600">$ {house.price}</div>
                </div>
                <div className="flex flex-col items-start gap-8 lg:flex-row">
                    <div className="max-w-[768px]">
                        <div className="mb-8">
                            <img src={house.imageLg} alt="image house" />
                        </div>
                    ...
                    <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
                        ...
                        <form className="flex flex-col gap-y-4">
                            ...
                            <textarea className="border border-gray-300 focus:border-violet-700 outline-none resize-none w-full rounde p-4 h-36 text-sm text-gray-400" placeholder="Message" defaultValue="Hello I am interested in [Modern apartment]"></textarea>
                            <div className="flex gap-x-2">
                                <button className="bg-violet-700 hover:bg-violet-800 text-sm w-full transition-all p-4 rounded text-white">Send message</button>
                                <button className="border border-violet-700 hover:border-violet-500 rounded p-4 hover:text-violet-500 text-violet-700 w-full text-sm transition-all">Call</button>
                            </div>
                        </form>
                    </div>
                </div>
